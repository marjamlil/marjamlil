...
More coming: the hooks and slash commands that hold my Claude Code setup together, and a template for the two-phase gather-then-decide command pattern the tools above share.
